...
use App\Models\Business\EmsCode;
use Illuminate\Support\Facades\Log;
/**
 * 商家发送短信
 * - author llc
 */
class BusinessEms extends Controller
{
    /** 发送单条
     * @param $mobile 发送的手机号
    ...
    public static function singleSend($mobile, $area='cn', $type = 0,$userid = '',$language= 'cn') {
        $code = BusinessEms::createContent($mobile, $area, $type, $userid);
        if ($area=='cn'){
...
//                  $templateId = '26244';   //国际短信 中文注册
    ...
    public static function createContent($mobile, $area, $type, $userid)
    {
        ...
        $result = DB::table('business_ems_code')->insert($data);
