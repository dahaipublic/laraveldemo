...
return [
    ...
    */
    ...
    'digits_between'       => ':attribute必须在:minand:max位之间',
    'dimensions'           => ':attribute图像尺寸不合法',
    'distinct'             => ':attribute值不能重复.',
    ...
    'required_if'          => ':attribute是必须的当:other是:value',
    'required_unless'      => ':attribute是必须的除非:other在:values中',
    'required_with'        => ':attribute是必须的当:values是存在的',
    'required_with_all'    => ':attribute是必须的当:values是存在的',
    'required_without'     => ':attribute是必须的当:values是不存在的',
    'required_without_all' => ':attribute是必须的当 没有一个:values是存在的',
